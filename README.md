...
## Descrição
Uma aplicação web rápida e amigável que consome dados do universo Pokémon, permitindo que o usuário consulte informações básicas e o visual oficial de diversas espécies.
